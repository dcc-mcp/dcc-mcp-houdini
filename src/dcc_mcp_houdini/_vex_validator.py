...
_ALLOWED_VEX_PATTERNS: List[re.Pattern] = [
    ...
    re.compile(
        ...
        r"len|length|length2|lerp|lighter|lookat|"
        r"match|find|max|min|minpos|mspace|nearpoint|nearpoints|neighbour|neighbourcount|nprimitives|"
        ...
        r"qconvert|quaternion|radians|random|raw_noise|reflect|refract|relbbox|relpointbbox|"
        r"removeattrib|removepoint|removeprim|removevertex|"
        r"renderstate|resize|rgbtohsv|rotate|"
