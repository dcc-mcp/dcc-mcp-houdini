...
- Quickinstall bundles the latest non-prerelease `dcc-mcp-core >= 0.19.91,<1.0.0` by default, or the validated `core_version` passed to a release backfill; no old-core pin is active.
